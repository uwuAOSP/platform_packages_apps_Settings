...
import com.android.settings.deviceinfo.firmwareversion.FirmwareVersionDetailPreference
import com.android.settings.deviceinfo.firmwareversion.SimpleBuildNumberPreference
    ...
    override fun getPreferenceHierarchy(context: Context, coroutineScope: CoroutineScope) =
        preferenceHierarchy(context) {
            +PreferenceCategory(
                ...
                {
                    +FirmwareVersionDetailPreference() order 0
                    +SimpleBuildNumberPreference() order 1
                    if (Flags.catalystAboutPhoneDeviceName()) {
                        +DeviceNamePreference(context) order 2
                    }
                    if (Flags.catalystDeviceModel()) +HardwareInfoScreen.KEY order 3
                }
            +MoreDeviceInfoScreen.KEY order 10
        }
